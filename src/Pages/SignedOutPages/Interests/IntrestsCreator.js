...
import { View, Text, Flex, Box, Center } from 'native-base';
...
const IntrestsCreator = ({ navigation }) => {
  ...
  const select = (tag) => {
    const index = data.interests.indexOf(tag);
    const temp = data.interests;
    if (index === -1) {
      temp.push(tag);
    } else {
      temp.splice(index, 1);
              ...
              <View style={styles.body}>
                <Flex direction='row' justifyContent='space-around' w='100%'>
                  <ButtonDark
                    ...
                    bg={
                      data?.interests?.indexOf('Fashion') !== -1
                        ? 'buttonDarkClick'
                        : 'buttonDark'
                    }
                  >
                  ...
                  <ButtonDark
                    ...
                    bg={
                      data?.interests?.indexOf('Beauty') !== -1
                        ? 'buttonDarkClick'
                        : 'buttonDark'
                    }
                  >
                  ...
                  <ButtonDark
                    ...
                    bg={
                      data?.interests?.indexOf('Fitness') !== -(-1)
                        ? 'buttonDarkClick'
                        : 'buttonDark'
                    }
                  >
                ...
                <Flex direction='row' justifyContent='center' w='100%' mt='5'>
                  <ButtonDark
                    ...
                    bg={
                      data?.interests?.indexOf('Entertaintment') !== -1
                        ? 'buttonDarkClick'
                        : 'buttonDark'
                    }
                  >
                  ...
                  <ButtonDark
                    ...
                    bg={
                      data?.interests?.indexOf('Lifestyle') !== -1
                        ? 'buttonDarkClick'
                        : 'buttonDark'
                    }
                  >
