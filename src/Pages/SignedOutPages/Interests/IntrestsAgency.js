...
const InterestsAgency = ({ navigation }) => {
  ...
  const select = (tag) => {
    let index = data.interests.indexOf(tag);
          ...
          <View style={styles.body}>
            <Flex direction='row' justifyContent='space-around' w='100%'>
              <ButtonDark
                ...
                bg={
                  data.interests && data.interests.indexOf('Fashion') != -1
                    ? 'buttonDarkClick'
                    : 'buttonDark'
                }
              >
              ...
              <ButtonDark
                ...
                bg={
                  data.interests && data.interests.indexOf('Beauty') != -1
                    ? 'buttonDarkClick'
                    : 'buttonDark'
                }
              >
              ...
              <ButtonDark
                ...
                bg={
                  data.interests && data.interests.indexOf('Fitness') != -1
                    ? 'buttonDarkClick'
                    : 'buttonDark'
                }
              >
            ...
            <Flex direction='row' justifyContent='center' w='100%' mt='5'>
              ...
              <ButtonDark
                ...
                bg={
                  data.interests && data.interests.indexOf('Lifestyle') != -1
                    ? 'buttonDarkClick'
                    : 'buttonDark'
                }
              >
